...
import { getClickData } from "@/utils/getTooltipData";
...
export const Calendar: FC<CalendarProps> = ({
  ...
  const debouncedHandleMouseOver = useRef(
    debounce(
      (
        ...
        clickData.rowId = page[clickData.rowIndex].id;
  ...
  useEffect(() => {
    ...
    gridArea.addEventListener("click", handleMouseOver);
    gridArea.addEventListener("mouseleave", handleMouseLeave);

    return () => {
      gridArea.removeEventListener("click", handleMouseOver);
