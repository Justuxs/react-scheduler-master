...
import defaultProfileImage from "../../../default-profile-picture.jpg";
  ...
  return (
    <StyledTileWrapper
      ...
      <StyledTextWrapper>
        <StyledImageWrapper>
          {data.icon ? (
            <StyledImage src={data.icon} alt="Icon"></StyledImage>
          ) : (
            <StyledImage src={defaultProfileImage} alt="Icon"></StyledImage>
          )}
        </StyledImageWrapper>
        <StyledStickyWrapper>
