...
export declare const Scheduler: ({ data, config, startDate, onRangeChange, onTileClick, onFilterData, onClearFilterData, onItemClick, onCellClick, isLoading }: SchedulerProps) => JSX.Element;

export declare type SchedulerCellClickData = Omit<ItemClickData, "data">;

export declare type SchedulerData = SchedulerRow[];

export declare type SchedulerItemClickData = Omit<SchedulerRow, "data">;
